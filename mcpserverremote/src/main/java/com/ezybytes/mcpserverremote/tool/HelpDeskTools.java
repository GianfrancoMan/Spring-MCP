...
public class HelpDeskTools {
     ...
     */
    @Tool(name = "createTicket", description = "Create the Support Ticket"/*, returndirect="false"*/)
    String createTicket(
    ...
    /*
     * Metodo Tool per recuperare i ticket di un utente
     */
    @Tool(name = "getTicketStatus", description = "Fetches the status of the tickets based on a given username")
